...
const navItems = [
  { label: 'HOME', icon: <HomeOutlinedIcon />, path: '/vite-react-booba/' },
  { label: 'TASKS', icon: <PaymentsRoundedIcon />, path: '/vite-react-booba/user-details' },

  { label: 'CALCULATOR', icon: <CurrencyExchangeOutlinedIcon />,         path: "/vite-react-booba/user-profile-page",
  },


  { label: 'PROFILE', icon: <QueryStatsOutlinedIcon />, path: '/vite-react-booba/news' },

  { label: 'WALLET', icon: <WalletIcon />, path: '/vite-react-booba/user-details' },
];
...
export default function SimpleBottomNavigation() {
  ...
  const shouldHideBottomNav = location.pathname === '/vite-react-booba/calculator';
